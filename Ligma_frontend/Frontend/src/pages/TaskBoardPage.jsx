...
const TABS = [
  {
    ...
    accentBg: "bg-[color:var(--primary-soft)]",
    accentBorder: "border-[color:var(--primary)]/20",
    indicatorColor: "bg-[color:var(--primary)]",
  },
  {
    id: "Decision",
    label: "Decisions",
    ...
    accentBg: "bg-[color:var(--secondary-soft)]",
    accentBorder: "border-[color:var(--secondary)]/20",
    indicatorColor: "bg-[color:var(--secondary)]",
  },
  {
    id: "Information",
    label: "Information",
    ...
    accentColor: "text-[color:var(--warning)]",
    accentBg: "bg-[color:var(--highlight-soft)]",
    accentBorder: "border-[color:var(--highlight)]/20",
    indicatorColor: "bg-[color:var(--highlight)]",
  },
  {
    id: "Reference",
    label: "References",
    ...
    accentColor: "text-[color:var(--foreground-secondary)]",
    accentBg: "bg-[color:var(--surface-muted)]",
    accentBorder: "border-[color:var(--border)]",
    indicatorColor: "bg-[color:var(--border-strong)]",
  },
];
