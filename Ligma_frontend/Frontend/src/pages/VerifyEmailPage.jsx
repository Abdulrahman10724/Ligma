...
export default function VerifyEmailPage() {
  ...
  const { user, verificationLoading, verificationState, verificationMessage } =
      ...
      return (
        <div className="flex flex-col items-center justify-center gap-4 rounded-3xl border border-[color:var(--border)] bg-[color:var(--surface)]/80 p-8 shadow-sm">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[color:var(--foreground-muted)]">
              {verificationMessage ||
                "Request a fresh link below and we’ll send it to your inbox."}
            </p>
          </div>
          <button
            type="button"
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4 rounded-3xl border border-[color:var(--border)] bg-[color:var(--surface)]/80 p-8 shadow-sm">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-[color:var(--foreground-muted)]">
            {verificationMessage ||
              "The verification link may have already been used or is invalid. Request a new one to continue."}
          </p>
        </div>
        ...
        <div className="max-w-xl space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm leading-7 text-[color:var(--foreground-muted)] sm:text-base">
              ...
              team’s workspace with confidence.
            </p>
          </div>
          {user?.email && (
