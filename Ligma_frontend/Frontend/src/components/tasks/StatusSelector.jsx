...
const STATUS_OPTIONS = [
  {
    ...
    label: "TO DO",
    Icon: Circle,
    iconColor: "text-[color:var(--foreground-muted)]",
    bg: "bg-[color:var(--surface-muted)]",
    border: "border border-[color:var(--border)]",
    badgeBg: "bg-[color:var(--surface-muted)]",
    badgeText: "text-[color:var(--foreground-muted)]",
  ...
  },
  {
    ...
    bg: "bg-[color:var(--highlight)]",
    border: "border-0",
    badgeBg: "bg-[color:var(--highlight-soft)]",
    badgeText: "text-[color:var(--warning)]",
    badgeBorder: "border border-[color:var(--highlight)]/30",
  },
  {
    value: "Completed",
    label: "COMPLETE",
    ...
    bg: "bg-[color:var(--success)]",
    border: "border-0",
    badgeBg: "bg-[color:var(--success-soft)]",
    badgeText: "text-[color:var(--success)]",
    badgeBorder: "border border-[color:var(--success)]/30",
  },
];
